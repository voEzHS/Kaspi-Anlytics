...
• Профессиональное оборудование для жарки/запекания — общепит, пекарни, фастфуд
• Новый для нас отдел на сайте (данные с июня 2026), подтипов пока нет —
  вся категория идёт под единым Тип "Жарочный шкаф"
• Целевой клиент: кафе, рестораны, фудкорты, кулинарии

ЛЬДОГЕНЕРАТОРЫ (ice_makers):
• Оборудование для производства льда — бары, рестораны, кафе, продуктовые точки
• Новый для нас отдел на сайте (данные с июня 2026), подтипов пока нет —
  вся категория идёт под единым Тип "Льдогенератор"
• Целевой клиент: HoReCa, бары, кафе
...
• Объединяет все категории (Морозильники, Холодильные витрины, Жарочные шкафы, Льдогенераторы)
...
async def generate_report(
    department: str = Query(..., description="freezers | refrigerated | ovens | ice_makers"),
