...
# 08.08 root-cause фикс — эта карта раньше содержала только 5 строк и
# пропускала категории, ЯВНО относящиеся к отделам сайта (напр.
# "Холодильные витрины" — буквально имя отдела "Холод. витрины" — вообще не
# было здесь, department=null; "Морозильные шкафы"/"Морозильные камеры
# коммерческие" — Морозильники, тоже department=null). Найдено директорским
# аудитом 08.08 через прямой live-запрос category->department по всем
# позициям на проде. Дополнено по семантике названия — это восстановленная
# карта, не заново откалиброванная человеком по каждой категории, могут
# оставаться пробелы (см. known_gaps в engine.calc_procurement_v2).
CORE_CRM_CATEGORIES = {
    # Морозильники (freezers)
    "Морозильные бонеты": "freezers",
    "Коммерческий морозильный ларь": "freezers",
    "Морозильные шкафы": "freezers",
    "Кухонные морозильные шкафы": "freezers",
    "Кухонные морозильные тумбы": "freezers",
    "Морозильные камеры коммерческие": "freezers",
    "Фризеры для мороженого": "freezers",
    # Холод. витрины (refrigerated)
    "Холодильные шкафы": "refrigerated",
    "Холодильные витрины": "refrigerated",
    "Холодильные горки, регалы": "refrigerated",
    "Кухонные холодильные тумбы": "refrigerated",
    "Кухонные холодильные шкафы": "refrigerated",
    "Фригобары и барные холодильники": "refrigerated",
    "Холодильные столы": "refrigerated",
